...
public class Generator {
    ...
    public Generator(HashMap<String, Double[][]> modelMap, int maxSamples, double maxTime, GuiRoot guiRoot) {
        ...
        for(int j=0; j<populations; j++) {
            ...
            for (int i = 0; i < specimens; i++) {
                ...
                if (evaluator.isValid) {
                    printEvaluatorStats(evaluator, pidMap);
    ...
    public void printEvaluatorStats(Evaluator evaluator, HashMap<String, Double> pidMap) {
        DecimalFormat df = new DecimalFormat("0.000");
        System.out.println("P = " + df.format(pidMap.get("P")) +
                "; I = " + df.format(pidMap.get("I")) +
                "; D = " + df.format(pidMap.get("D")));
